...
#pdf("/Users/leggettr/Desktop/BAMBI/BAMBI_EvenMock_nbc_11032019_insilico_88888(200bp,80pc)_group(70pc).pdf", width=3.6, height=7);
#amrdata <- read.delim("/Users/leggettr/Desktop/BAMBI/MockInsilico8(200bp,80pc)_group(70pc).txt", sep="\t",head=TRUE, check.names=FALSE)

#pdf("/Users/leggettr/Desktop/BAMBI/P103M_Both(200bp,80pc)_group(70pc).pdf", width=4, height=10);
...
# #e41a1c
#pdf("/Users/leggettr/Desktop/BAMBI/P10_group2_(200bp,80pc)_group(70pc).pdf", width=4, height=11.5);
#amrdata <- read.delim("/Users/leggettr/Desktop/BAMBI/P10_group2_(200bp,80pc)_group(70pc).txt", sep="\t",head=TRUE, check.names=FALSE)

# #4daf4a
pdf("/Users/leggettr/Desktop/BAMBI/P10_group3_(200bp,80pc)_group(70pc).pdf", width=3.6, height=7.3);
